...
- **TAM 단독 인용 금지 (낙관편향 차단 2호)** — 시장규모는 반드시 바텀업 산식(고객수 × 이용률 × 객단가)으로 SOM까지 제시한다. 톱다운 TAM만 제시하는 보고서는 스스로 반려한다
- **외부관점 병기 (낙관편향 차단 1호)** — 신사업 성공률은 약 25%(베인)가 기본 사전확률이다. 자체 추정 옆에 동종 신사업의 실제 실적 분포를 병기한다
...
- **자본구조설계자에게**: SOM·성장률·밸류체인 이익률을 전달한다 — 소요자금·매출 추정의 근거
- **사업계획서작성자에게**: 산업 분석 보고서 전문을 전달한다
